...
?>
					...
					foreach ($result as $row) { ?>
						...
						<div class="container text-left" style="padding: 0;">
							<div class="row g-3">
								...
								<div class="col-sm-3">
									<?php $stmt =  mysqli_query($con, "SELECT * FROM second_sem WHERE student_id=" . $id);
									$result = mysqli_fetch_assoc($stmt); ?>
	...
	$(document).ready(function() {
		// Disable all input, button, and select elements in the form
		$('form input, form button, form select').prop('disabled', true);
		$('form input:disabled, form button:disabled, form select:disabled').css('color', 'black');
	});
</script>
